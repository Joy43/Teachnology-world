...
const Cardshow = () => {
  const products = [
    ...
    },
    {
      ...
      description:
        'Explore the diversity of The Bahamas with 16 major islands...',
      price: 110,
      rating: 4.96,
      sells: 76,
      isPopular: true,
    ...
    {
      imgSrc:
        'https://i.ibb.co/j4RLJ3W/nicolas-j-leclercq-q-DLLP0y-P7-FU-unsplash.jpg',
      title: 'Modern Gaming Setup',
      description:
        'Experience the pinnacle of gaming setups with cutting-edge technology...',
      price: 150,
      rating: 4.9,
      sells: 50,
      isPopular: false,
